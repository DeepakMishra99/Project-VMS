...
import java.sql.*;
public class Employee_Datatable extends JFrame {
	JTable jt;int i=0;int j=0;
	String cols[]= {"Employee ID","Employee Name","Email","Phone","Address","Gender","HOD ID","Department ID"};
	Connection con;Statement st;ResultSet rs;
	DefaultTableModel tb=new DefaultTableModel();
	
	public Employee_Datatable() {
	// TODO Auto-generated constructor stub
		setSize(1400,800);
		setTitle("EMPLOYEE DATA TABLE");
		setVisible(true);
